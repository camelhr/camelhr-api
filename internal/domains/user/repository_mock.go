...
func (_m *RepositoryMock) CreateUser(ctx context.Context, orgID int64, email string, passwordHash string, isOwner bool) (User, error) {
...
func (_m *RepositoryMock) DeleteUser(ctx context.Context, id int64) error {
...
func (_m *RepositoryMock) DisableUser(ctx context.Context, id int64, comment string) error {
...
func (_m *RepositoryMock) EnableUser(ctx context.Context, id int64, comment string) error {
	ret := _m.Called(ctx, id, comment)
...
func (_m *RepositoryMock) GenerateAPIToken(ctx context.Context, id int64) error {
	ret := _m.Called(ctx, id)
...
func (_m *RepositoryMock) GetUserByAPIToken(ctx context.Context, apiToken string) (User, error) {
...
func (_m *RepositoryMock) GetUserByID(ctx context.Context, id int64) (User, error) {
	ret := _m.Called(ctx, id)
...
func (_m *RepositoryMock) GetUserByOrgIDEmail(ctx context.Context, orgID int64, email string) (User, error) {
...
func (_m *RepositoryMock) GetUserByOrgSubdomainAPIToken(ctx context.Context, orgSubdomain string, apiToken string) (User, error) {
...
func (_m *RepositoryMock) GetUserByOrgSubdomainEmail(ctx context.Context, orgSubdomain string, email string) (User, error) {
...
func (_m *RepositoryMock) ResetAPIToken(ctx context.Context, id int64) error {
	ret := _m.Called(ctx, id)
...
func (_m *RepositoryMock) ResetPassword(ctx context.Context, id int64, passwordHash string) error {
