...
func (_m *RepositoryMock) CreateOrganization(ctx context.Context, subdomain string, name string) (Organization, error) {
...
func (_m *RepositoryMock) GetOrganizationBySubdomain(ctx context.Context, subdomain string) (Organization, error) {
...
func (_m *RepositoryMock) UpdateOrganization(ctx context.Context, id int64, name string) error {
