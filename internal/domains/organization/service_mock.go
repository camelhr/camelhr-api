...
func (_m *ServiceMock) BlacklistOrganization(ctx context.Context, id int64, comment string) error {
...
func (_m *ServiceMock) DeleteOrganization(ctx context.Context, id int64) error {
...
func (_m *ServiceMock) GetOrganizationByID(ctx context.Context, id int64) (Organization, error) {
	ret := _m.Called(ctx, id)
...
func (_m *ServiceMock) GetOrganizationByName(ctx context.Context, name string) (Organization, error) {
...
func (_m *ServiceMock) UnblacklistOrganization(ctx context.Context, id int64, comment string) error {
	ret := _m.Called(ctx, id, comment)
...
func (_m *ServiceMock) UnsuspendOrganization(ctx context.Context, id int64, comment string) error {
	ret := _m.Called(ctx, id, comment)
