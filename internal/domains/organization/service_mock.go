...
func (_m *ServiceMock) SuspendOrganization(ctx context.Context, id int64) error {
	ret := _m.Called(ctx, id)
...
func (_m *ServiceMock) UnsuspendOrganization(ctx context.Context, id int64) error {
	ret := _m.Called(ctx, id)
